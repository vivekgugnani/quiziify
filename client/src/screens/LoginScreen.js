                    ...
                    <Row className="row">
                        <Col className="logo" xs={12} lg={6}>
                            ...
                            <Col className="description">
                                Create and Join Quiz at a single platform. You can create and participate trivia quizzes, personality test, polls and surveys. Especially created for blind students
                                too. Share out your quiz with your students with a unique code.
                            </Col>
                        </Col>
